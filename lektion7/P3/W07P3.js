...
function initSphereNormalMap(gl){
...
function initCubeNormalMap(gl){
    ...
    image.src = './textures/normalmap.png';
    gl.uniform1i(gl.getUniformLocation(gl.programcube, "texMap"), 1);
}
